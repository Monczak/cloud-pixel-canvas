<script lang="ts">
  ...
  let { onCanvasUpdate }: { onCanvasUpdate?: () => Promise<void> } = $props();
    ...
    <div class="palette-area">
      <div class="swatch-row">
        {#each fixedColors as c, i}
          <button
            class="swatch"
            class:active={$activeSlot.type === "fixed" &&
              $activeSlot.index === i}
            style="background: {c}"
            onclick={() => selectSlot("fixed", i)}
      ...
      <div class="swatch-row">
        {#each $customColors as c, i}
          <button
            ...
            class:active={$activeSlot.type === "custom" &&
              $activeSlot.index === i}
            class:empty={c === null}
            style:background={c ?? "transparent"}
            onclick={() => selectSlot("custom", i)}
